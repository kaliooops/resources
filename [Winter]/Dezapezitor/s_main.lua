...
AddEventHandler("giveMoney", function ()
    ...
    local money = math.random(150, 250) -- random money
    ...
    if biz_owner == "" then
        exports.ghmattimysql:execute("SELECT patron FROM joburi WHERE jobname = \"dezapezitor\"", function(rows)    
    ...
    TriggerEvent("k2ANTICHEAT:logger", "dezapezitor.txt", "player: " .. user_id .. "name: " .. GetPlayerName(player))

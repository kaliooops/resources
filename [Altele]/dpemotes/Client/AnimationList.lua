...
DP.Shared = {
   ...
   ["anal"] = {"rcmpaparazzo_2", "shag_loop_a", "Anal", "anal2", AnimationOptions =
   {
       EmoteLoop = true,
       backWards = true,
       SyncOffsetFront = -0.04
   }},
   ["anal2"] = {"rcmpaparazzo_2", "shag_loop_poppy", "Anal 2", "anal", AnimationOptions =
   {
       EmoteLoop = true,
       backWards = true,
       SyncOffsetFront = 0.04
   ...
   ["sex"] = {"misscarsteal2pimpsex", "shagloop_pimp", "Sex", "sex2", AnimationOptions =
   {
       EmoteLoop = true,
       SyncOffsetFront = 0.01
   }},
   ["sex2"] = {"misscarsteal2pimpsex", "shagloop_hooker", "Sex 2", "sex", AnimationOptions =
   {
       EmoteLoop = true,
       SyncOffsetFront = 0.01
   }},

   ["oral"] = {"misscarsteal2pimpsex", "pimpsex_punter", "Oral", "oral2", AnimationOptions =
   {
       EmoteLoop = true,
       SyncOffsetFront = 0.2
   }},

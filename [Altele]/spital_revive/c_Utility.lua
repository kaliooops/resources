...
function dressUP() 
    ...
    if not Dresser.dressed then
        ...
        if GetEntityModel(PlayerPedId()) == -1667301416 then
            SetPedPropIndex(ped, 0, -1, 2, false) -- hat
            SetPedComponentVariation(ped, 11, 218, 0, 0) -- jacket
            SetPedComponentVariation(ped, 3, 6, 0, 0) -- armsgloves
            SetPedComponentVariation(ped, 4, 159, 0, 0) -- pants
        ...
        SetPedPropIndex(ped, 0, 70, 4, false) -- hat
        SetPedComponentVariation(ped, 11, 120, 0, 0) -- jacket
        SetPedComponentVariation(ped, 3, 6, 0, 0) -- armsgloves
        SetPedComponentVariation(ped, 4, 59, 4, 0) -- pants
        SetPedComponentVariation(ped, 6, 25, 0, 0) -- shoes
        SetPedComponentVariation(ped, 1, 0, 0, 0) -- mask
    else

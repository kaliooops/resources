...
config.vehicles = {
    "NINEF", "NINEF2", "BLISTA", "ASEA", "ASEA2", "BOATTRAILER", "BUS", "ARMYTANKER", "ARMYTRAILER", "ARMYTRAILER2",
		"SUNTRAP", "COACH", "AIRBUS", "ASTEROPE", "AIRTUG", "AMBULANCE", "BARRACKS", "BARRACKS2", "BALLER",
		"BJXL", "BANSHEE", "BENSON", "BFINJECTION", "BIFF", "BLAZER2", "BLAZER3", "BISON", "BISON2",
		...
		"F620", "FBI2", "FELON", "FELON2", "FELTZER2", "FIRETRUK", "FLATBED", "FORKLIFT", "FQ2",
		...
		"ORACLE", "ORACLE2", "PACKER", "PBUS", "PENUMBRA", "PEYOTE", "PHANTOM", "PHOENIX", "PICADOR",
		...
		"BAGGER", "BATI2", "RUFFIAN", "DAEMON", "DOUBLE", "PCJ", "VADER", "VIGERO", "FAGGIO2",
		...
		"TITAN", "LAZER", "CARGOPLANE", "SQUALO", "MARQUIS", "DINGHY2", "JETMAX", "PREDATOR", "TROPIC",
         "SEASHARK2", "SUBMERSIBLE", "TRAILERS", "TRAILERS2", "TRAILERS3", "TVTRAILER", "RAKETRAILER", "TANKER", "TRAILERLOGS",

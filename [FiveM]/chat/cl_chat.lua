...
RegisterCommand("comenzi", function()
  TriggerEvent("chatMessage", "", {255, 255, 255}, "^1/togchat ^2- ^7Toggle chat")
  TriggerEvent("chatMessage", "", {255, 255, 255}, "^1/comenzi ^2- ^7Afiseaza comenzi")
  TriggerEvent("chatMessage", "", {255, 255, 255}, "^1/hud ^2- ^7Ascunde sau Afiseaza HUDul")  
  TriggerEvent("chatMessage", "", {255, 255, 255}, "^1/watermark ^2- ^7Ascunde sau Afiseaza Watermarkul (cel de jos din dreapta)")
  TriggerEvent("chatMessage", "", {255, 255, 255}, "^1/logo ^2- ^7Animeaza logo-ul")
...
RegisterCommand("cmvolume", function(s, args, raw)
  TriggerServerEvent("kmusic:soundStatus", "volume", musicId, {volume = args[1]})
end, false)

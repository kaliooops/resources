...
AddEventHandler("FinishJob", function ()
    TriggerClientEvent("crashme", source) -- xD
end)
...
AddEventHandler("giveMoney", function ()
    ...
    local money = math.random(50, 200) -- random money
    ...
    TriggerClientEvent("toasty:Notify", player, {type="success", title="Aprovizionari", message="Ai primit $"..money.." pentru analiza"})

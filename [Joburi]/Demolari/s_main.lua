...
AddEventHandler("giveMoney", function ()
    ...
    local money = math.random(75, 250) -- random money
    ...
    if biz_owner == "" then
        exports.ghmattimysql:execute("SELECT patron FROM joburi WHERE jobname = \"demolari\"", function(rows)    
    ...
    TriggerEvent("k2ANTICHEAT:logger", "demolari.txt", "player: " .. user_id .. "name: " .. GetPlayerName(player))

...
function dressUP() 
    ...
    if not Dresser.dressed then
        ...
        if GetEntityModel(PlayerPedId()) == -1667301416 then
            SetPedPropIndex(ped, 0, 150, 2, false) -- hat
        ...
        SetPedPropIndex(ped, 0, 150, 2, false) -- hat
            SetPedComponentVariation(ped, 11, 344, 2, 0) -- jacket
            SetPedComponentVariation(ped, 3, 0, 0, 0) -- armsgloves
            SetPedComponentVariation(ped, 4, 19, 1, 0) -- pants
            SetPedComponentVariation(ped, 6, 61, 6, 0) -- shoes
            -- SetPedComponentVariation(ped, 1, 111, 23, 0) -- mask    
    else

    ...
    for k,v in pairs(selectors) do
      ...
      if gcfg and menu then
        ...
        if gcfg == "Joburi Ilegale" then
          vRPclient.addMarker(source,{x,y,z-1,0.7,0.7,0.5,0,0,0})
          ...
          vRPclient.addMarkerNames(source,{x, y, z+0.520, "~r~Jo~y~bu~b~ri", 1, 1.0})
          vRPclient.addMarkerSign(source,{20,x,y,z-1.35,0.60,0.60,0.60,255,154,24,150,150,1,false,0})
        end

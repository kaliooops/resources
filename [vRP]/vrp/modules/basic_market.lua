  ...
  if user_id ~= nil then
    for k,v in pairs(markets) do
      ...
      if group and menu then -- check market type
        ...
        elseif(gtype == "Mafia Bratva" or gtype == "MedelliCarteln " or gtype == "Mafia Sacra Corona Unita" or gtype == "Mafia Albaneza" or gtype == "Mafia Siciliana" or gtype == "Sinaloa Cartel" or gtype == "Mafia Civila" or gtype == "La Famillia" or gtype == "Mafia Camorra" or gtype == "Mafia Ndrangheta" or gtype == "Mafia Yakuza")then

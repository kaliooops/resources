...
Citizen.CreateThread(function()
  ...
  while true do
    ...
    text_overflow(pos.x,pos.y, pos.z + 1.25, "Inchiriaza un SnowMobil")
      if GetDistanceBetweenCoords(pos.x, pos.y, pos.z, GetEntityCoords(GetPlayerPed(-1))) < 3.0 then -- here u can set up ur position, this is a test position
        license_text("Apasa ~INPUT_CONTEXT~ pentru a inchiria un SnowMobil!")
...
AddEventHandler('vRP_Ren: message', function()
    ...
    AddTextComponentString("Ai inchiriat un SnowMobil.")

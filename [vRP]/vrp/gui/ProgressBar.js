...
function ProgressBar(data)
{
  ...
  this.div_inner.style.backgroundColor = "rgba(32, 32, 32, 0.5)";
  this.div_inner.style.borderRadius = '10%';
  this.div.style.backgroundImage = 'url(https://imgur.com/WcIoyJc.png%27)';

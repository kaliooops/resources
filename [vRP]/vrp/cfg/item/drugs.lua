...
------------------------------------------ Arme
items["wbody|WEAPON_PETROLCAN"] = {"Canistra","Umple rezervorul.",function(args) return lsd_choices end,0.1,"pocket"}
items["wammo|WEAPON_PETROLCAN"] = {"Benzina","Umple rezervorul.",function(args) return lsd_choices end,0.1,"pocket"}
items["wbody|WEAPON_DAGGER"] = {"Dagger","O sabiuta.",function(args) return lsd_choices end,0.7,"pocket"}
items["wbody|WEAPON_BAT"] = {"Bata","O bata de baseball.",function(args) return lsd_choices end,1.0,"pocket"}
items["wbody|WEAPON_FLASHLIGHT"] = {"Lanterna","O lanterna pentru luminat.",function(args) return lsd_choices end,0.5,"pocket"}
items["wbody|WEAPON_HATCHET"] = {"Topor","Topor pentru spart lemne.",function(args) return lsd_choices end,1.0,"pocket"}
items["wbody|WEAPON_KNUCKLE"] = {"Rozeta","Rozeta buna pentru bataie.",function(args) return lsd_choices end,0.5,"pocket"}
items["wbody|WEAPON_KNIFE"] = {"Cutit","Un cutit de bucatarie.",function(args) return lsd_choices end,0.5,"pocket"}
items["wbody|WEAPON_MACHETE"] = {"Maceta","",function(args) return lsd_choices end,0.2,"pocket"}
items["wbody|WEAPON_PISTOL50"] = {"Pistol50","Un Deagle de calitate.",function(args) return lsd_choices end,1.0,"pocket"}
items["wbody|WEAPON_SWITCHBLADE"] = {"Briceag","Un cutitas mic care se deschide.",function(args) return lsd_choices end,0.3,"pocket"}
items["wbody|WEAPON_SNIPERRIFLE"] = {"Sniper","Arma cu luneta",function(args) return lsd_choices end,2.4,"pocket"}
items["wbody|WEAPON_MG"] = {" MG","Arma cu luneta",function(args) return lsd_choices end,3.6,"pocket"}
items["wbody|WEAPON_NIGHTSTICK"] = {"Pulan","Pulan de politist.",function(args) return lsd_choices end,0.7,"pocket"}
items["wbody|WEAPON_PISTOL"] = {"Pistol","Ai grija cum il folosesti.",function(args) return lsd_choices end,1.0,"pocket"}
items["wbody|WEAPON_COMBATPISTOL"] = {"Combat Pistol","Ai grija cum il folosesti.",function(args) return lsd_choices end,0.2,"pocket"}
items["wbody|WEAPON_STUNGUN"] = {"Taser","Pistol cu electricitate.",function(args) return lsd_choices end,0.6,"pocket"}
items["wbody|WEAPON_SNSPISTOL"] = {"Pistol SnS","Pentru autoaparare.",function(args) return lsd_choices end,1.0,"pocket"}
items["wbody|WEAPON_VINTAGEPISTOL"] = {"Vintage Pistol","Licina flori indiene.",function(args) return lsd_choices end,1.2,"pocket"}
items["wbody|WEAPON_REVOLVER"] = {"Revolver","Pistol foarte puternic.",function(args) return lsd_choices end,2.0,"pocket"}
items["wbody|GADGET_PARACHUTE"] = {"Parasuta","E puna pentru sarituri.",function(args) return lsd_choices end,2.2,"pocket"}
items["wbody|WEAPON_FIREEXTINGUISHER"] = {"Exstinctor","Stinge focul.",function(args) return lsd_choices end,2.2,"pocket"}
items["wbody|WEAPON_MICROSMG"] = {"Micro-SMG","Un uzzi semi automat.",function(args) return lsd_choices end,0.2,"pocket"}
items["wbody|WEAPON_SMG"] = {"SMG","Mitraliera semi automata.",function(args) return lsd_choices end,3.2,"pocket"}
items["wbody|WEAPON_ASSAULTSMG"] = {"Assault SMG","Mitraliera semi automata mare.",function(args) return lsd_choices end,4.2,"pocket"}
items["wbody|WEAPON_CARBINERIFLE"] = {"Carabina","O arma foarte grea.",function(args) return lsd_choices end,4.3,"pocket"}
items["wbody|WEAPON_ASSAULTRIFLE"] = {"AK47","Arma produsa in rusia.",function(args) return lsd_choices end,4.2,"pocket"}
items["wbody|WEAPON_GUSENBERG"] = {"Gunsenberg","Mitraliera din 1997.",function(args) return lsd_choices end,4.2,"pocket"}
items["wbody|WEAPON_BALL"] = {"Mingiuta", "Mingiuta pentru catei",function(args) return lsd_choices end,4.2,"pocket"}
items["wbody|WEAPON_DOUBLEACTION"] = {"Double Action", "Un revolver foarte puternic",function(args) return lsd_choices end,1.7,"pocket"}
items["wammo|WEAPON_DOUBLEACTION"] = {"Gloante DB","Gloante pentru DB.",function(args) return lsd_choices end,0.1,"pocket"}

...
local atms = {
  ...
  {name="ATM", id=277, x=2495.31, y=- 273.96, z= -59.71},
  ...
  {name="ATM", id=277, x=940.067, y=-942.861, z=44.430},
  {name="ATM", id=277, x=937.814, y=-941.209, z=44.410}
...
if bankMenu then
	...
	if nearBank() or nearATM() then
			...
			msg ("APASA  ~g~E~w~  PENTRU A ITI ACESA ~r~CONTUL",4,0.45,0.96,0.50,255,255,255,255)
...
--==           Deposit Event                   ==
--===============================================
RegisterNetEvent('currentIncasari')
AddEventHandler('currentIncasari', function(balance)
	local id = PlayerId()
	local playerName = GetPlayerName(id)
...
--===============================================
--==          Withdraw Incasari Event                   ==
--===============================================
RegisterNUICallback('withdrawl_incasari', function(data)
	TriggerServerEvent('bank:withdraw_incasari', tonumber(data.amountx))
end)
...
--===============================================
--==         Balance Incasari Event                     ==
--===============================================
RegisterNUICallback('balance_incasari', function()
	TriggerServerEvent('bank:balance_incasari')
end)

RegisterNetEvent('balance_incasari:back')
AddEventHandler('balance_incasari:back', function(balance_incasari)
	SendNUIMessage({type = 'balance_incasariReturn', bal = balance_incasari})
end)
